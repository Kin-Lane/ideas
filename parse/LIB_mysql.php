...
define("MYSQL_USERNAME", "academic");         // Define your MySQL user name
define("MYSQL_PASSWORD", "@c@demic");         // Define your MySQL password
define("DATABASE", "academic");               // Define your default database
